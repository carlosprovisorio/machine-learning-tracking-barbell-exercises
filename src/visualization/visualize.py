...
participant_df = data_frame.query("label == 'bench'").sort_values("participant").reset_index()
...
label = "squat"
participant = "A"
all_axis_df = data_frame.query(f"label == '{label}'").query(f"participant == '{participant}'").reset_index()
